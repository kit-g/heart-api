...
Future<ChartPreferenceResponse> getChartPreferences(Request req) async {
...
Future<ChartPreference> saveChartPreference(Request req) async {
...
Future<Model> deleteChartPreference(Request req) async {
  final service = req.chartPreferenceService;
